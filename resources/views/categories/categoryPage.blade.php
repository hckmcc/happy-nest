...
@section('content')
    ...
    <div class="bg-white min-h-screen py-8">
        <div class="container mx-auto px-4 h-screen">
            <h2 class="text-3xl font-bold text-center text-gray-800">{{$category->name}}</h2>
            @if($regularAds->count() > 0 or $promotedAds->count() > 0)
            ...
            @else
                <div class="text-center content-center h-full">
                    ...
                    <p class="text-gray-500">В этой категории еще нет объявлений</p>
                </div>
            @endif
        </div>
    </div>
